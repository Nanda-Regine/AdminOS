      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-xl px-3 py-2.5 text-sm bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2D4A22]"
            ...
            {error && (
              <div className="on-light bg-red-50 border border-red-200 rounded-xl px-4 py-3 text-sm text-red-700">
                {error}
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/signup" className="text-[#2D4A22] font-medium hover:underline">
              Start free trial
            </Link>
          </p>
        </div>
