...
| — | *Still open before conference: RESEND_API_KEY still dead (deprioritized — demo won't touch live signup/invite); safety_incidents/employment_equity_data still have no UI* |
